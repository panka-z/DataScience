      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav navbar-right hidden-sm hidden-xs">
            <li onclick="" style="margin-left:-10px;padding-left:3px;margin-right: 20px;"><a href="https://datascience.suvenconsultants.com/elearning/#microcourses" class="head_panel" style="font-size:14px">Online Courses</a></li>
            <li style="margin-left:-10px;padding-left:3px;color:#fcba03;margin-right: 20px;"><a href="https://docs.google.com/forms/d/e/1FAIpQLScPpX9SPBQkjj5xklDta_EOO0mADa-st3Zw8941ThkS5woKCQ/viewform" target="_blank" class="head_panel" style="font-size:14px; color:#fcba03 !important;"><div class="checkmark checkmark-animation"></div>&nbsp;&nbsp;Join Wait List</a></li>
          ...
          <ul class="nav navbar-nav navbar-right hidden-lg hidden-md">
            ...
            <li style="margin-top:-5px; color:#fcba03;"><a  href="https://docs.google.com/forms/d/e/1FAIpQLScPpX9SPBQkjj5xklDta_EOO0mADa-st3Zw8941ThkS5woKCQ/viewform" target="_blank"  class="head_panel" style="font-size:14px; color:#fcba03; !important"><div class="checkmark checkmark-animation"></div>&nbsp;&nbsp;Join Wait List</a></li>
          ...
          <div class="row">
              <div class="col-lg-12 col-md-12 text-center center-block">
                  ...
                  <div class="col-md-4 text-left">
                      ...
                      <p><a class="" style="margin-left: 10%;font-size:13px;" href="https://datascience.suvenconsultants.com/elearning#microcourses" target="_blank">e-Learning with Micro-courses</a></p>
                      <br><br><br><br>
                  </div>
                  <div class="col-md-4 text-left">
